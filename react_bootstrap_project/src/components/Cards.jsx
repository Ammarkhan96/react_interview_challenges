        ...
        <Container className='mt-5' fluid>
            <Row>
                ...
                <Card bg='dark' text='white' className='shadow-lg'>
                    <Card.Img variant='top' src={image1} width="100%" height="260px" />
                ...
                <Col>
                <Card bg='dark' text='white' className='shadow-lg'>
                    <Card.Img variant='top' src={image2} width="100%" height="260px" />
                    <Card.Body>
                ...
                <Col>
                <Card bg="dark" text="white" className="shadow-lg">
                    <Card.Img variant='top' src={image3} width="100%" height="260px" />
                    <Card.Body>
